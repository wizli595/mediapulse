...
class AkhbaronaSpider(AbstractSpider):
    ...
    def base_url(self) -> str:
        return "https://www.akhbarona.com"
    ...
    def parse_article(self, url: str) -> Article | None:
        ...
        cat_links = soup.select('a[href*="index.1.html"]')
        category = cat_links[0].get_text(strip=True) if cat_links else None
        ...
        return Article(
            ...
            author=self._text(soup, "span.author"),
            category=category,
        )
